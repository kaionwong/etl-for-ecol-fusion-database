...
if __name__ == "__main__":
    ...
    tables_to_backup = ['CL_STATUS_HISTORY', 'ECR_SYNCHRONIZATION_ACTION', 'ECR_SYNCHRONIZATION_ACTION_LOG']  # Change this to a list of table names to specify, e.g., ['COLLISIONS']
