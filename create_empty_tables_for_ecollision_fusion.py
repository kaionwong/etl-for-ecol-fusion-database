# This creates all the empty tables for eCollision Fusion DB. The specification and formats of these tables will be the same as eCollision Analytics DB's.
